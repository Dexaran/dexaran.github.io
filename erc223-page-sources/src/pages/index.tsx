  ...
  return (
    <div className={styles.page}>
      ...
      <header className={styles.header}>
        ...
        <br></br>
        <p> As the result of lack of transaction handling a new method of depositing tokens to contracts was introduced in ERC-20: approve & transferFrom mechanism. This is a pull transaction which is not designed for trustless decentralized payment system which further increases the risks for ERC-20 token users. ERC-223 standard is the only Ethereum token standards that solves this problems. We fight for the security of blockchain industry and its users. We believe that letting a user to lose all his life savings as a result of a mistake that could be easily prevented is not acceptable for a global standard of digital assets. </p>
        <br></br>
